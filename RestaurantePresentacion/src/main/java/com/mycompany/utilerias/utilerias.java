 ...
 */
/**
 * Clase utilitaria que contiene métodos estáticos para estilizar los componentes
...
public class utilerias {
    ...
    /**
     * Aplica un estilo básico a un botón de menú eliminando bordes,
     * fondo y efecto de enfoque, además de cambiar el cursor a mano.
     * 
    ...
    /**
     * Configura un botón para mostrar un logo como imagen,
     * eliminando texto, bordes y fondo.
     * 
    ...
    /**
     * Escala una imagen desde una ruta específica y la asigna como icono
     * a un botón.
     * 
    ...
    /**
     * Aplica un estilo básico a un botón primario, eliminando el enfoque
     * visual y cambiando el cursor.
     * 
    ...
    /**
     * Aplica un estilo personalizado a una tabla,
     * incluyendo colores, altura de filas, encabezado y comportamiento
     * visual al seleccionar filas.
     * 
    ...
    /**
     * Aplica un estilo a un botón sin fondo, con colores personalizados
     * y cursor tipo mano.
     * 
     * @param btn Botón a estilizar
     */
